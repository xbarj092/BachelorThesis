...
namespace MapGenerator
{
    public class MapGenerator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _aStar = new AStar();
            _roomGenerator = new RoomGenerator(this, _emptySpaceFillPrefab);
        ...
        private IEnumerator SpawnMap()
        {
            ...
            _hallwayGenerator.GenerateHallways(_bowyerWatson.GenerateTriangularMesh(_roomGenerator.PlacedRooms),
                _roomGenerator.PlacedRooms, _aStar, _primsAlg, _hallwayPrefab, _hallwayFloorPrefab, _emptySpaceFillPrefab);
